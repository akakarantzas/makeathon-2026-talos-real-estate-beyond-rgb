...
from .paths import BACKEND_CODE_DATA_DIR, get_data_path, require_data_path
...
def load_scene(plot_name: str) -> dict:
    ...
    image_path = require_data_path(scene_path.name, "SPECTRAL_IMAGE.TIF")
    metadata_path = require_data_path(scene_path.name, "METADATA.XML")
